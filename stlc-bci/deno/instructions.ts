...
const instructions: Array<Instruction> = [
  ...
  { name: "PUSH_INT", opcode: InstructionOpCode.PUSH_INT, args: [OpParameter.OPInt], },
  { name: "PUSH_VAR", opcode: InstructionOpCode.PUSH_VAR, args: [OpParameter.OPInt, OpParameter.OPInt], },
  { name: "PUSH_CLOSURE", opcode: InstructionOpCode.PUSH_CLOSURE, args: [OpParameter.OPLabel], },
  ...
  { name: "JMP_TRUE", opcode: InstructionOpCode.JMP_TRUE, args: [OpParameter.OPLabel], },
  ...
  { name: "STORE_VAR", opcode: InstructionOpCode.STORE_VAR, args: [OpParameter.OPInt], },
];
